export default function CTA() {
  return (
    <section className="xero-card relative w-full max-w-[1600px] mx-auto rounded-[20px] overflow-hidden px-10 py-25 pb-27.5 text-center flex flex-col items-center mb-20 max-[768px]:px-5 max-[768px]:py-17.5 max-[768px]:mb-12">
      {/* Gradient arc */}
      ...
      <div className="relative z-1 inline-flex items-center gap-2 text-[0.75rem] text-[--text-muted] uppercase tracking-[0.14em] px-3.5 py-1.5 rounded-full bg-white/3 mb-6">
        <span className="w-1.5 h-1.5 rounded-full bg-[--accent-pink] shadow-[0_0_8px_var(--accent-pink)]" />
        Ready to run
      </div>

      <h2 className="xero-section-title relative z-1 font-light leading-[1.1] tracking-tight m-0 mb-4 max-w-190">
      ...
      <p className="relative z-1 text-white/45 text-[0.95rem] mb-8 max-w-120">
